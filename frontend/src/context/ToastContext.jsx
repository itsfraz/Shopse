...
const Toast = ({ message, type, onClose }) => {
    ...
    return (
        <motion.div
            ...
            className={`pointer-events-auto flex items-center gap-3 px-4 py-3 min-w-[300px] rounded-lg shadow-lg border backdrop-blur-md bg-white/95 dark:bg-gray-800/95 ${styles[type] || styles.info}`}
        >
            {icons[type]}
